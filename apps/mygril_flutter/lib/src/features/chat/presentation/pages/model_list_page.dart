    ...
    return Scaffold(
      ...
      body: settingsAsync.when(
        ...
        data: (settings) {
          ...
          // 获取所有模型类型
          final allTypes = ModelType.values.where((type) => 
            groupedProviders.containsKey(type.value)
          ).toList();
          ...
          return Column(
            children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: ModelType.values.map((type) {
                      ...
                      final isSelected = _selectedModelType == type.value;
                        ...
                        child: FilterChip(
                          ...
                          label: Row(
                            ...
                            children: [
                              ...
                              Text(type.label),
                              if (hasProviders && count > 0) ...[ 
                                const SizedBox(width: 4),
                                Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                  decoration: BoxDecoration(
                                    color: isSelected ? colors.surface : colors.primary.withOpacity(0.2),
                          ...
                          onSelected: hasProviders ? (selected) {
                            setState(() {
                              _selectedModelType = type.value;
                            });
                          } : null,
                          backgroundColor: colors.surface,
                          ...
                          labelStyle: TextStyle(
                            color: isSelected ? Colors.white : (hasProviders ? colors.text : colors.muted),
                          ),
                          disabledColor: colors.surface.withOpacity(0.3),
              ...
              Expanded(
                child: () {
                  final providers = groupedProviders[_selectedModelType] ?? [];
                  ...
                  providers.sort((a, b) => _providerTitle(a).toLowerCase().compareTo(_providerTitle(b).toLowerCase()));
